...
namespace RTGUtils
{
	...
	RUNTIMEGEOMETRYUTILS_API bool LoadSimpleObj(const FString& fileName, FDynamicMesh3& MeshOut, bool flip = false,bool bVcolor = false,bool bNormal = false, bool bUV = false);
}
