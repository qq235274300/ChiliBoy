...
UCLASS()
class INTERACTIVETOOLSKIT_API URuntimeDrawPolygonToolBuilder : public UDrawPolygonToolBuilder
{
	GENERATED_BODY()
...
class INTERACTIVETOOLSKIT_API URuntimeDrawPolygonToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(BlueprintType)
class INTERACTIVETOOLSKIT_API URuntimeDrawPolygonTool : public UDrawPolygonTool
{
	GENERATED_BODY()
