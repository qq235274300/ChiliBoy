...
class INTERACTIVETOOLSKIT_API URuntimeMeshBooleanToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class INTERACTIVETOOLSKIT_API URuntimeMeshBooleanTool : public UCSGMeshesTool
{
	GENERATED_BODY()
...
UCLASS()
class INTERACTIVETOOLSKIT_API URuntimeMeshBooleanToolBuilder : public UCSGMeshesToolBuilder
{
	GENERATED_BODY()
public:
