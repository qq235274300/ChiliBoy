 ...
 */
class INTERACTIVETOOLSKIT_API FSimpleDynamicMeshComponentTargetFactory : public FComponentTargetFactory
{
public:
 ...
 */
class INTERACTIVETOOLSKIT_API FSimpleDynamicMeshComponentTarget : public FPrimitiveComponentTarget
{
public:
